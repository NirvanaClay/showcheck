...
const Header = ({ resetSlider, loginStatus, Link, LogoutForm, setUser, setLoginStatus }) => {
  ...
  return (
    <div className='navbar'>
      <ul>
        ...
        <li>{loginStatus && <LogoutForm setUser={setUser} setLoginStatus={setLoginStatus} resetSlider={resetSlider} />}</li> 
